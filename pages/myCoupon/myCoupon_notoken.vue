			...
			<view class="f-column-center">
				<view class="myPopup_qrcode f-column-between-center">
					<view class="f-column-center">
						...
						<view class="popup_text2" style="margin-top: 12rpx;">{{popupInfo.goodsname}}</view>
						<view class="popup_text3" style="margin-top: 24rpx;">请扫描二维码进行验证</view>
					</view>
	...
	export default {
		...
		methods: {
			...
			getList: function() {
				...
				let data = uni.getStorageSync('myCouponList');
				
				that.isLoading = true;
				that.loadStatus = 'loading';
				
				this.Http.apiResquest(this.api.Getmycoupon, data, "POST").then((res) => {
